...
debug.DEBUG_ENGINE.libraries['combine_url'] = 'admin_patch.templatetags.combine_url'
debug.DEBUG_ENGINE.template_libraries['combine_url'] = import_library('admin_patch.templatetags.combine_url')
